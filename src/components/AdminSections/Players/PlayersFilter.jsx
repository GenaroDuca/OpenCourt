...
export default function PlayersFilter({
  ...
  return (
    <div className="flex flex-row  md:gap-4 gap-2 justify-between items-center mt-2 md:mt-4 bg-background-card-color p-4 rounded-lg md:rounded-lg border border-border-color">
      {/* Search Input */}
      <div className="relative w-full flex-1">
        ...
        <input
          ...
          placeholder="Buscar jugador, nombre, numero de telefono..."
          value={searchTerm}
